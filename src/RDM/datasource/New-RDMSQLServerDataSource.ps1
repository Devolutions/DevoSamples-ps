<#FRONTMATTER
id: New-RDMSQLServerDataSource
title: New-RDMSQLServerDataSource
product: RDM
category: datasource
...
.DESCRIPTION
Provides New-RDMSQLServerDataSource, which:
...
.EXAMPLE
New-RDMSQLServerDataSource -Name "Production" -Server "SQL01" -Database "RDMDB"
...
function New-RDMSQLServerDataSource
{
    param (
